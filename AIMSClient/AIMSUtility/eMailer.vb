...
Namespace AIMS.Utility
    ...
    Public Class eMailer
        ...
        Private Function Receive() As String
            ...
            oMail.Connect("operations@aims.org.za", "T3amOps$2021", "za-smtp-inbound-1.mimecast.co.za")
        End Function
        ...
        Public Function SendEmail(ByVal EmailBody As String,
                                    ByVal EmailFrom As String,
                                    ByVal EmailFromName As String,
                                    ByVal EmailSubject As String,
                                    ByVal EmailTo As String,
                                    ByVal EmailAttachments As String,
                                    Optional ByVal KillFiles As Boolean = True,
                                    Optional ByVal EmailCC As String = "",
        ...
        Private Function TestEmail(Optional ByVal EmailBody As String = "", Optional ByVal EmailFrom As String = "", Optional ByVal EmailSubject As String = "", Optional ByVal EmailTo As String = "", Optional ByVal emailAttachment As String = "", Optional ByVal EmailCC As String = "", Optional ByVal EmailBcc As String = "") As Boolean
            ...
            Try
                ...
                Dim netCred As New Net.NetworkCredential("operations@aims.org.za", "T3amOps$2021")
